...
![AppVersion: 1.104.4](https://img.shields.io/badge/AppVersion-1.104.4-informational?style=flat-square)
...
| opencost.exporter.livenessProbe | object | `{"enabled":true,"failureThreshold":3,"initialDelaySeconds":30,"periodSeconds":10}` | Liveness probe configuration |
...
| opencost.exporter.readinessProbe | object | `{"enabled":true,"failureThreshold":3,"initialDelaySeconds":30,"periodSeconds":10}` | Readiness probe configuration |
...
| opencost.ui.livenessProbe | object | `{"enabled":true,"failureThreshold":3,"initialDelaySeconds":30,"periodSeconds":10}` | Liveness probe configuration |
...
| opencost.ui.readinessProbe | object | `{"enabled":true,"failureThreshold":3,"initialDelaySeconds":30,"periodSeconds":10}` | Readiness probe configuration |
