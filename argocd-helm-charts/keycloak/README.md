...
* Go to [clients console](http://localhost:8888/auth/admin/master/console/#/realms/master/clients) and click on `Create`.
...
* Once done, you can go ahead create all the respective groups you want in Keycloak.
  1. From [Keycloak homepage](https://keycloak.your.domain.com/auth/admin/master/console/) go to [groups
     page](https://keycloak.your.domain.com/auth/admin/master/console/#/realms/master/groups) and click on `new`
  2. Provide the new group's name and click save.

* Add the users to the group
  1. From [Keycloak homepage](https://keycloak.your.domain.com/auth/admin/master/console/) go to [users
     page](https://keycloak.your.domain.com/auth/admin/master/console/#/realms/master/users) and click on `View all
     users`
  2. Go `Groups`
...
### How to give a user an admin access in Keycloak and not in Kubernetes
...
* From [Keycloak homepage](https://keycloak.your.domain.com/auth/admin/master/console/) go to [users
  console](https://keycloak.your.domain.com/auth/admin/master/console/#/realms/master/users) and click on `View all
  users`
* Click on `Add User`
...
* Click on `Role Mappings` and under `Available Roles` select `admin` and click on `Add Selected` (it automatically
  saves and you should see green colour popup alert toolbox)

    NOTE: `admin` role is quite powerful, so be cautious about this when assigning this role and its only available in
    `master` realm
...
* From [Keycloak homepage](https://keycloak.your.domain.com/auth/admin/master/console/) go to [Identity
    Providers](https://keycloak.your.domain.com/auth/admin/master/console/#/realms/devops/identity-provider-settings)
